...
import { fetchProduct } from '../../../state/product/productActions'
                    ...
                    <div className="">
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <div className='flex gap-3 items-end'>
                                <p className="text-3xl tracking-tight text-green-500">{product.discountedPrice}</p>
                                <p className='text-2xl line-through text-gray-400'>{product.price}</p>
                            </div>
