                    ...
                    <TabList className="-mb-px flex space-x-8 px-4">
                      {navigation.categories.map((category) => (
                        <Tab
                          ...
                          className={({ selected }) =>
                            classNames(
                              selected ? 'text-hover' : 'border-transparent text-primary',
            ...
            <div className="flex h-16 items-center">
                ...
                <div className="flex h-full space-x-8">
                                          ...
                                          >
                                            {section.items.map((item) => (
                                              <li key={item.name} className="flex">
                                                <a href={item.href} className="text-black hover:text-hover">
                                                  {item.name}
                                                </a>
                                              </li>
                                            ))}
                  ...
                  {navigation.pages.map((page) => (
                    <a
                      key={page.name}
                      href={page.href}
                      className="flex items-center text-sm font-medium hover:text-hover"
                    >
                      {page.name}
                    </a>
                  ))}
              ...
              <div className="ml-auto flex items-center">
                ...
                <div className="flex lg:ml-6">
                  <a href="#" className="p-2 text-gray-400 hover:text-hover">
                ...
                <div className="ml-4 flow-root lg:ml-6">
                  <a href="#" className="group -m-2 flex items-center p-2">
                    <ShoppingBagIcon
                      className="h-6 w-6 flex-shrink-0 group-hover:text-hover"
                      aria-hidden="true"
                    />
                    <span className="ml-2 text-sm font-medium group-hover:text-hover">0</span>
