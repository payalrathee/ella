...
public class ProductDto {
    ...
    @DecimalMin(value = "0.0", message = "Please enter a valid discounted price", groups = {CreateProductGroup.class, UpdateProductGroup.class})
    private Double discountedPrice;

    @DecimalMin(value = "0.0", message = "Please enter a valid discount", groups = {CreateProductGroup.class, UpdateProductGroup.class})
